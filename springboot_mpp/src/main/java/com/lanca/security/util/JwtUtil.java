package com.lanca.security.util;
...
//        String meihongliang = generate("meihongliang");
//        System.out.println("生成token后内容： " + meihongliang);
//        Claims parse = parse(meihongliang);
//        System.out.println(parse);
//        assert parse != null;
//        System.out.println(parse.getId());
//        System.out.println("生成时间:" + parse.getIssuedAt());
//        System.out.println("过期时间:" + parse.getExpiration());
//    }
