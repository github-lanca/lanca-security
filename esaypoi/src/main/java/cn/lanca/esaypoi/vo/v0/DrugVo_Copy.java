...
public class DrugVo_Copy {
     ...
     *
     */
    @ExcelProperty(value = "网店商品分组", index = 8)
    private String a8;
    /**
     *
     */
    @ExcelProperty(value = "药品分类", index = 9)
    private String a9;
    /**
     *
     */
    @ExcelProperty(value = "药品类型", index = 10)
    private String a10;
    /**
     *
     */
    @ExcelProperty(value = "非处方甲乙类", index = 11)
    private String a11;
    /**
     *
     */
    @ExcelProperty(value = "甲乙类功能分类", index = 12)
    private String a12;
    /**
     *
     */
    @ExcelProperty(value = "产品剂型", index = 13)
    private String a13;
    /**
     *
     */
    @ExcelProperty(value = "贮藏条件", index = 14)
    private String a14;
    /**
     *
     */
     ...
     *
     */
    @ExcelProperty(value = "药品规格", index = 16)
    private String a16;
    /**
     *
     */
