 ...
 * @version 1.0.0<br>
 * @since 2022/3/25 14:18  <br>
 */
public class B_84124 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        // #3生成图片文件，excel文件
        File file2 = new File("/Users/meihongliang/Downloads/A_xiaowan/fri/A_全部数据_84124.xlsx");
    ...
    private static List<CommonVo> get3A() throws FileNotFoundException {
        ...
        String a = "/Users/meihongliang/Downloads/OTC药品系列-数据表.xls";
    ...
    private static List<CommonVo> get48() throws FileNotFoundException {
        ExcelListener<CommonVo> userListener = new ExcelListener<>();
        String b = "/Users/meihongliang/Downloads/处方药-数据表.xls";
